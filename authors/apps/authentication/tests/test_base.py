...
class BaseTestClass(TestCase):
    def setUp(self):
        self.user_data = {
            ...
            "password": "Butt3rfly1"}
        self.invalid_user = {
            "email": "hacker@someplace.cc", "password": "123passsing"}
    ...
    def auth_header_token(self):
        ...
        self.login_credentials = {
            "email": "user@sprinters.ug", "password": "Butt3rfly1"}
        response = self.client.post(
            reverse('auth:login'), data=self.login_credentials, format='json')
    ...
    def verified_user_login_token(self):
        ...
        response = self.client.post(
            reverse('auth:login'), data=self.user_data, format='json')
